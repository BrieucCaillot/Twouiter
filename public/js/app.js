...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Common/FollowComponent.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Common/FollowComponent.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Common/PostComponent.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Common/PostComponent.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  methods: {
    ...
    getPosts: function getPosts() {
      ...
      axios.get('/api/allposts').then(function (response) {
        return _this3.allPosts = response.data;
      }).catch(function (error) {
        return console.log(error);
      });
    },
    showMorePosts: function showMorePosts() {
      ...
      axios.get(this.allPosts.next_page_url).then(function (response) {
        _this4.allPosts.next_page_url = response.data.next_page_url;

        for (var post in response.data.data) {
          _this4.allPosts.data.push(response.data.data[post]);
        }
      }).catch(function (error) {
        return console.log(error);
      });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    showMorePosts: function showMorePosts() {
      ...
      axios.get(this.posts.next_page_url).then(function (response) {
        _this3.posts.next_page_url = response.data.next_page_url;

        for (var post in response.data.data) {
          _this3.posts.data.push(response.data.data[post]);
        }
      }).catch(function (error) {
        return console.log(error);
      });
    },
    showMoreFollowings: function showMoreFollowings() {
      var _this4 = this;

      axios.get(this.user.paginateFollowings.next_page_url).then(function (response) {
        _this4.user.paginateFollowings.next_page_url = response.data.paginateFollowings.next_page_url;

        for (var following in response.data.paginateFollowings.data) {
          _this4.user.paginateFollowings.data.push(response.data.paginateFollowings.data[following]);
        }
      }).catch(function (error) {
        return console.log(error);
      });
    ...
    showMoreFollowers: function showMoreFollowers() {
      ...
      axios.get(this.user.paginateFollowers.next_page_url).then(function (response) {
        ...
        for (var following in response.data.paginateFollowers.data) {
          _this5.user.paginateFollowers.data.push(response.data.paginateFollowers.data[following]);
        }
      }).catch(function (error) {
        return console.log(error);
      });
    ...
    changeFollow: function changeFollow(followtype) {
      ...
      axios.post("/api/user/".concat(followtype), {
        ...
        return _this6.getUser(_this6.username);
      }).catch(function (error) {
        return console.log(error);
      });
    },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "level" }, [
      _c("h1", { staticClass: "is-size-3 has-text-white" }, [_vm._v("Sign In")])
    ])
  },
  function() {
    var _vm = this
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "level" }, [
      _c("h1", { staticClass: "is-size-3 has-text-white" }, [_vm._v("Sign Up")])
    ])
  },
  function() {
    var _vm = this
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Common/FollowComponent.vue?vue&type=template&id=c8fe379a&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Common/FollowComponent.vue?vue&type=template&id=c8fe379a& ***!
  \*************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
      ...
      _c("div", { staticClass: "columns" }, [
        _c("div", { staticClass: "column" }, [
          _c(
            ...
            {
              staticClass:
                "posts__post shadow mg-t1 has-background-white columns is-vcentered is-flex"
            },
            [
              ...
              _c("div", { staticClass: "column posts__post__right" }, [
                _c("div", { staticClass: "level is-mobile has-text-left" }, [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Common/PostComponent.vue?vue&type=template&id=1e886938&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Common/PostComponent.vue?vue&type=template&id=1e886938& ***!
  \***********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return _c("div", { staticClass: "columns" }, [
    _c("div", { staticClass: "column" }, [
      _c(
        ...
        {
          staticClass:
            "posts__post shadow mg-t1 has-background-white columns is-flex",
          class:
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Post/PostsComponent.vue?vue&type=template&id=00daed84&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Post/PostsComponent.vue?vue&type=template&id=00daed84& ***!
  \**********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
      ...
      _vm.user.username.length > 0
        ? _c("div", { staticClass: "columns is-multiline" }, [
            _c(
              ...
              {
                staticClass:
                  "column user__profile shadow full-h is-3 is-12-touch"
              },
              [
                ...
                _c("div", { staticClass: "columns is-vcentered" }, [
                  _c("div", { staticClass: "user__right column" }, [
                    _c(
                      "div",
                      { staticClass: "level is-mobile user__profile__name" },
                      [
                        _c(
                          "a",
                          {
                            staticClass:
                              "user__profile__name mauto has-text-centered",
                            attrs: { href: /user/ + _vm.user.username }
                          },
                          [_vm._v(_vm._s(_vm.user.name))]
                        )
                    ...
                    _c("div", { staticClass: "level has-text-centered" }, [
                      _c(
                        ...
                        {
                          staticClass:
                            "mauto has-text-center user__profile__username"
                        },
                        [_vm._v("@" + _vm._s(_vm.user.username))]
                      )
                    ])
                ...
                _c("div", { staticClass: "columns is-flex-mobile" }, [
                  _c("div", { staticClass: "column" }, [
                    ...
                    _c(
                      "p",
                      { staticClass: "user__profile__count has-text-centered" },
                      [_vm._v(_vm._s(_vm.user.countPosts))]
                    )
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "column" }, [
                    ...
                    _c(
                      "p",
                      { staticClass: "user__profile__count has-text-centered" },
                      [_vm._v(_vm._s(_vm.user.countFollowings))]
                    )
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "column" }, [
                    ...
                    _c(
                      "p",
                      { staticClass: "user__profile__count has-text-centered" },
                      [_vm._v(_vm._s(_vm.user.countFollowers))]
                    )
                  ])
                ])
              ]
            ...
            _c(
              ...
              [
                _c(
                  ...
                  {
                    staticClass:
                      "posts__newpost shadow columns background-color-secondary has-text-white"
                  },
                  [
                    _c("div", { staticClass: "column" }, [
                      _c(
                ...
                _vm._v(" "),
                _vm._l(_vm.allPosts.data, function(post) {
                  return _vm.allPosts.data.length > 0
                    ? _c("PostComponent", {
                        key: post.id,
                        attrs: {
                          post: post,
                ...
                _vm._v(" "),
                _vm.allPosts.data.length > 0 &&
                _vm.allPosts.next_page_url !== null
                  ? _c("div", { staticClass: "columns mg-t2" }, [
                      _c("div", { staticClass: "column" }, [
                        _c("div", { staticClass: "level" }, [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Profile/ProfileComponent.vue?vue&type=template&id=0b8f50f6&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Profile/ProfileComponent.vue?vue&type=template&id=0b8f50f6& ***!
  \***************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
            ...
            _c(
              "form",
              {
                ...
                on: {
                  submit: function($event) {
                    $event.preventDefault()
                    return _vm.updateUser(_vm.user.username)
                  }
                }
              },
              [
                    ...
                    _c("div", { staticClass: "columns is-flex-mobile" }, [
                      _c("div", { staticClass: "column" }, [
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "user__profile__count has-text-centered"
                          },
                          [_vm._v(_vm._s(_vm.user.countPosts))]
                        )
                      ]),
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "column posts__center pd4 shadow background-color-secondary is-6 is-12-touch"
                  },
                  [
                    _vm._m(1),
                    _vm._v(" "),
                        ...
                        _vm.imageData.length > 0
                          ? _c("div", { staticClass: "level" }, [
                              _c("div", { staticClass: "image-preview" }, [
                                _c("img", {
                                  staticClass: "preview",
                                  attrs: { src: _vm.imageData, alt: "image" }
                                })
                              ])
                            ])
                          : _vm._e()
  ...
  function() {
    ...
    return _c("div", { staticClass: "columns" }, [
      _c("div", { staticClass: "column" }, [
        _c("div", { staticClass: "level" }, [
          _c("div", { staticClass: "level-left" }, [
            _c("h1", { staticClass: "has-text-white is-size-4" }, [
              _vm._v("Profile")
            ])
          ])
        ])
                        ...
                        _vm.userIdConnected == _vm.user.id
                          ...
                          ? _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.changeFollow("follow")
                                  }
                                }
                              },
                              [
                          ...
                          ? _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.changeFollow("unfollow")
                                  }
                                }
                              },
                              [
              ...
              _c(
                ...
                [
                  ...
                  _vm._l(_vm.posts.data, function(post) {
                    return _vm.selected == "tweets" && _vm.posts.data.length > 0
                      ? _c("PostComponent", {
                          key: post.id,
                          attrs: {
                            post: post,
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.user.paginateFollowings.data, function(following) {
                    return _vm.selected == "followings" &&
                      _vm.user.paginateFollowings.data.length > 0
                      ? _c("FollowComponent", {
                          key: following.id,
                          attrs: { post: following }
                        })
                      : _vm._e()
                  }),
                  _vm._v(" "),
                  _vm._l(_vm.user.paginateFollowers.data, function(follower) {
                    return _vm.selected == "followers" &&
                      _vm.user.paginateFollowers.data.length > 0
                      ? _c("FollowComponent", {
                          key: follower.id,
                          attrs: { post: follower }
                        })
...
Vue.component('profile-component', __webpack_require__(/*! ./components/Profile/ProfileComponent */ "./resources/js/components/Profile/ProfileComponent.vue").default);
/**
...
/***/ "./resources/js/components/Common/FollowComponent.vue":
/*!************************************************************!*\
  !*** ./resources/js/components/Common/FollowComponent.vue ***!
  \************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _FollowComponent_vue_vue_type_template_id_c8fe379a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FollowComponent.vue?vue&type=template&id=c8fe379a& */ "./resources/js/components/Common/FollowComponent.vue?vue&type=template&id=c8fe379a&");
/* harmony import */ var _FollowComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FollowComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/Common/FollowComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _FollowComponent_vue_vue_type_template_id_c8fe379a___WEBPACK_IMPORTED_MODULE_0__["render"],
  _FollowComponent_vue_vue_type_template_id_c8fe379a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Common/FollowComponent.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Common/FollowComponent.vue?vue&type=script&lang=js&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/Common/FollowComponent.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/Common/FollowComponent.vue?vue&type=template&id=c8fe379a&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/components/Common/FollowComponent.vue?vue&type=template&id=c8fe379a& ***!
  \*******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_FollowComponent_vue_vue_type_template_id_c8fe379a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./FollowComponent.vue?vue&type=template&id=c8fe379a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Common/FollowComponent.vue?vue&type=template&id=c8fe379a&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_